...
def launch_training_job(parent_dir: str, data_dir: str, job_name: str, params: dict):
    """Launch training of the model with a set of hyperparameters in parent_dir/job_name

    Args:
        parent_dir: directory containing config, weights and log
        data_dir: directory containing the dataset
        params: containing hyperparameters
    """
